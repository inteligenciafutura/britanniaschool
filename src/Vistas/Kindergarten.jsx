        ...
        <div className="rowNosotros">
          ...
          <div className="colNosotros">
            ...
            <p className="text-justifyNosotros">
              Britannia School adopta un enfoque de aprendizaje temprano en el
              que el niño y la niña se coloca en el centro de su aprendizaje en
              un entorno seguro y acogedor. Se invita a los niños pequeños de
              tres a seis años a explorar su entorno y expresarse a través de
              muchos “lenguajes” o diferentes formas de expresión, que incluyen
              palabras, movimiento, dibujo, pintura, escultura, juego de
              sombras, collage y música. Se acompaña a los niños a participar en
              su curiosidad innata y cada variación en la investigación se
              considera valiosa. Nuestro idioma predomínate de la enseñanza es
              el inglés. Buscamos formar niños felices, seguros de sí mismos,
              con respeto por la naturaleza y con un aprendizaje éxitos.
            </p>
          </div>
        </div>
