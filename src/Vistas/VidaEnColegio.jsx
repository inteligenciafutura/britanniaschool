      ...
      {isMobile ? (
       <div>
        ...
        <h1 className="titulosVida">
          Mi experiencia en el Britannia School ha sido asombrosa. He tenido la
          oportunidad de mejorar mi inglés y ahora puedo tener conversaciones
          con mis profesores y compañeros de clase.
        </h1>
        ...
        <div className="rowNosotros">
          <div className="colNosotros">
            ...
            <p className="text-justifyNosotros">
              ...
              creemos que es más allá del aula donde se construye el carácter y
              se forjan los ciudadanos del mañana.<br></br>
              Ofrecemos gran cantidad de actividades de enriquecimiento para
              estudiantes de todas las edades; la danza, el teatro, el arte, el
              debate, la música, los deportes y muchas opciones interesante: Lo
              que anima a cada alumno a encontrar algo especial que les ayude a
              desarrollar las cualidades, actitudes y habilidades personales
              para complementar su éxito académico.
            </p>
          </div>
          <div className="colNosotros">
            <Carousel
        ...
        <div className="rowNosotros">
          ...
          <div className="colNosotros">
            ...
            <p className="text-justifyNosotros">
              ...
              llamativo uniforme al que preferimos referirnos como “multiforme”.
              <br></br>
        ...
        <div className="rowNosotros">
          <div className="colNosotros">
            ...
            <p className="text-justifyNosotros">
              ...
              una cultura escolar positiva para involucrarlos y apoyarlos en su
              aprendizaje.<br></br>
              ...
              por ser una comunidad educativa donde los estudiantes y profesores
              puedan relacionarse bien entre sí, donde se valoren y respeten
              diferentes ideas y puntos de vista.<br></br>
              ...
              críticos mientras siempre promovemos nuestros valores escolares de
              respeto mutuo, amabilidad, diversidad, aceptación, responsabilidad
              y logros.
            </p>
          </div>
          <div className="colNosotros">
